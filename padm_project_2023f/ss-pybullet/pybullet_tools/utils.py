    ...
    def collision_fn(q, verbose=False):
        ...
        for link1, link2 in check_link_pairs:
            ...
            if (not use_aabb or aabb_overlap(get_moving_aabb(body), get_moving_aabb(body))) and \
                ...
                print('returned HERRRREER', body, link1, body, link2)
                print(q)
...
def body_collision(body1, body2, max_distance=MAX_DISTANCE): # 10000
    ...
    # if len(p.getClosestPoints(bodyA=body1, bodyB=body2, distance=max_distance,
        ...
        # print('body_collision', body1, body2, max_distance, p.getClosestPoints(bodyA=body1, bodyB=body2, distance=max_distance,
        #                           physicsClientId=CLIENT))
    return len(p.getClosestPoints(bodyA=body1, bodyB=body2, distance=max_distance,
                                  physicsClientId=CLIENT)) != 0 # getContactPoints`
